...
- (void)replaceChild:(GDataXMLNode *)old cur:(GDataXMLNode*)cur;//add by weizhiqiang
...
- (GDataXMLNode *)attributeForNameCaseInsensitive:(NSString *)name;//up or lower case  insensitive
