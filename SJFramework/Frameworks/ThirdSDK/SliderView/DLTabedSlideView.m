...
#define kDefaultTabbarHeight 44//头部tab的高度
#define kDefaultTabbarBottomSpacing 0
#define kDefaultCacheCount 4 //最多tab是4个。（<＝4）
...
- (void)commonInit{
    ...
    slideView_ = [[DLSlideView alloc] initWithFrame:CGRectMake(0, 0+self.tabbarHeight+self.tabbarBottomSpacing, self.bounds.size.width, self.bounds.size.height-self.tabbarHeight-self.tabbarBottomSpacing)];
